  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        medium: "0 4px 20px -4px hsl(var(--foreground) / 0.1), 0 8px 16px -8px hsl(var(--foreground) / 0.06)",
        elevated: "0 8px 30px -6px hsl(var(--foreground) / 0.12), 0 12px 24px -12px hsl(var(--foreground) / 0.08)",
        "2xs": "var(--shadow-2xs)",
        xs: "var(--shadow-xs)",
        sm: "var(--shadow-sm)",
        md: "var(--shadow-md)",
